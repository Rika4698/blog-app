 ...
 const searchParams = useSearchParams();
  ...
  const handleGithubLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        const formPayload = { ...formData, image };
        // const form = e.target;
        ...
        title='Github'
          ...
          className="cursor-pointer w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
                                ...
                                <form onSubmit={handleSubmit} className="mx-auto max-w-xs">
                                    ...
                                    <label htmlFor="file" className="mb-1 block text-sm font-medium text-gray-700 mt-5">Upload file</label>
                                    <input type="file"
                                        accept="image/*"
                                        onChange={(e) => setImage(e.target.files[0])}
                                        required className='mt-2 block w-full text-sm file:mr-4 file:rounded-md file:border-0 file:bg-blue-500 file:py-2 file:px-4 file:text-sm file:font-semibold file:text-white hover:file:bg-blue-700 focus:outline-none disabled:pointer-events-none disabled:opacity-60"' />
                                    <input
